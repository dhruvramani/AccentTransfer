...
wav_loc = "../save/plots/output/raw_output.wav" 
noise_loc = "../save/plots/output/raw_noise.wav" 

rate_noise, data_noise = wavfile.read(noise_loc)
...
output = removeNoise(audio_clip=data, noise_clip=data_noise,verbose=True,visual=True)
print(output)
wavfile.write("../save/plots/output/denoised.wav", rate, output)
